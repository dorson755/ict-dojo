...
const exercises = [
  ...
  },
  {
    ...
    passage: 'nation action unhappy return education division impossible automatic the with question',
    hint: 'Feel the chunk or prefix as one motion, not individual letters.',
    difficulty: 2,
    grades: [2, 12],
  },
  {
